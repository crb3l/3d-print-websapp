        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { image: 'https://blog.snapmaker.com/content/images/size/w1000/2025/03/flexible-to-be-stretched-tpu-filament.jpg', name: 'TPU', desc: 'TPU (Thermoplastic Polyurethane) is a flexible, rubber-like plastic known for its high elasticity, abrasion resistance, and durability. It is often used for phone cases, wearables, automotive parts, and flexible 3D prints. TPU is more difficult to print than rigid materials but offers excellent shock absorption and flexibility.' },
